...
namespace LOGGER
{
	...
	//日志级别的提示信息
	static const std::string strFatalPrefix = "[F]\t";
	static const std::string strErrorPrefix = "[E]\t";
	static const std::string strWarningPrefix = "[W]\t";
	static const std::string strInfoPrefix = "[I]\t";
	static const int logcount = 20;
	...
	public:
        ...
        static CLogger& getInstance()
                {
                static CLogger logger(LogLevel_Info, CLogger::GetAppPathA().append("log/"),false);
                return logger;
            }
	public:
